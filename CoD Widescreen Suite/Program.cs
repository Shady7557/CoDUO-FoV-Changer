...
namespace CoD_Widescreen_Suite
{
    ...
    {
        private const string MUTEX_NAME = nameof(CoD_Widescreen_Suite) + "_SingleInstanceMutex";

        public const string MEMORY_MAPPED_NAME = nameof(CoD_Widescreen_Suite) + "_SingleInstanceMemoryMappedFile";
        ...
        private static void InitLog()
        {
            ...
            try
            {
                ...
                var logLocation = sb.Clear().Append(PathInfos.LogsPath).Append(@"\CWS_").Append(DateTime.Now.ToString("d")).Replace("/", "-").Append(".log").ToString();
