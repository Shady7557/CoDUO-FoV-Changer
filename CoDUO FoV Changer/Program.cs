...
namespace CoDUO_FoV_Changer
{
    ...
    {
        private const string MUTEX_NAME = "CoDUOFoVChanger_SingleInstanceMutex";

        public const string MEMORY_MAPPED_NAME = "CoDUOFoVChanger_SingleInstanceMemoryMappedFile";
