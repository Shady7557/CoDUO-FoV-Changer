...
// Major modifications made by me to make the button's color changeable.
...
namespace Sce.Atf.Controls
{
    ...
    public class SplitButton : Button
    {
        ...
        protected override void OnMouseUp(MouseEventArgs mevent)
        {
            ...
            {
                SetButtonDrawState();
                if (Bounds.Contains(Parent.PointToClient(Cursor.Position)) && !_dropDownRectangle.Contains(mevent.Location)) //removed _dropdown check or some shit
                {
                    OnClick(new EventArgs());

                    // This is madness.
                    // but, having this here enables the ability to use OnMouseDown's event,
                    // and this means you can then check which button was pressed.
                    // This is useful for, for example, seeing if it was left click & simply performing a normal left click option where you are *not* clicking
                    // the drop-down side of the button.
                    // Therefore, if someone were to right click the button even away from the drop-down side, they'll get the context strip.
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            // Draw the white border around the control
            using (Pen borderPen = new Pen(SystemColors.ControlLightLight))
            {
            ...
            {
                TextRenderer.DrawText(g, Text, Font, focusRect, this.ForeColor, formatFlags);
            }
