...
'            Case "mp3"
'                mciSendString("open """ & _filename & """ type mpegvideo alias audiofile", Nothing, 0, CInt(CInt(IntPtr.Zero)))

'                Dim playCommand As String = "play audiofile from 0"

'                If _wait = True Then playCommand += " wait"

'                mciSendString(playCommand, Nothing, 0, CInt(CInt(IntPtr.Zero)))
'            Case "wav"
'                mciSendString("open """ & _filename & """ type waveaudio alias audiofile", Nothing, 0, CInt(CInt(IntPtr.Zero)))
'                mciSendString("play audiofile from 0", Nothing, 0, CInt(CInt(IntPtr.Zero)))
'            Case "mid", "idi"
...
'    ''' <remarks></remarks>
'    Public Sub Pause()
'        mciSendString("pause audiofile", Nothing, 0, CInt(CInt(IntPtr.Zero)))
'        IsPaused = True
'    End Sub
...
'    ''' <remarks></remarks>
'    Public Sub [Resume]()
'        mciSendString("resume audiofile", Nothing, 0, CInt(CInt(IntPtr.Zero)))
'        IsPaused = False
'    End Sub
...
'    ''' <remarks></remarks>
'    Public Sub [Stop]()
'        mciSendString("stop audiofile", Nothing, 0, CInt(CInt(IntPtr.Zero)))
'    End Sub
...
'    ''' <remarks></remarks>
'    Public Sub Close()
'        mciSendString("close audiofile", Nothing, 0, CInt(CInt(IntPtr.Zero)))
'    End Sub
...
'            mciSendString("set audiofile time format milliseconds", Nothing, 0, CInt(IntPtr.Zero))
'            mciSendString("status audiofile length", buf, 255, CInt(IntPtr.Zero))
...
'        Get
'            Dim buf As String = Space(255)
'            mciSendString("status audiofile mode", buf, 255, CInt(IntPtr.Zero))
'            buf = Replace(buf, Chr(0), "")  ' Get rid of the nulls, they muck things up
'            Return buf
'        End Get
'    End Property
...
'        Get
'            Try
'                Return CInt(My.Computer.FileSystem.GetFileInfo(_filename).Length)
...
'        Get
'            Dim buf As String = Space(255)
'            mciSendString("status audiofile channels", buf, 255, CInt(IntPtr.Zero))
